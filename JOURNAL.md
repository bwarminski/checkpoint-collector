...
- Wrote a follow-on implementation plan at `docs/superpowers/plans/2026-04-12-collector-comment-metadata-plan.md` to supersede only the metadata-related parts of the original collector-correctness plan. The checkpoint-side execution target remains the dedicated worktree at `/home/bjw/checkpoint/.worktrees/collector-correctness-checkpoint`.
